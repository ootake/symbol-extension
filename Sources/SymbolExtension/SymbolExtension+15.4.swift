...
public extension SymbolExtension {
    ...
    static let dots_and_line_vertical_and_cursorarrow_rectangle: SymbolExtension = SymbolExtension(rawValue: "dots.and.line.vertical.and.cursorarrow.rectangle")
    static let key_viewfinder: SymbolExtension = SymbolExtension(rawValue: "key.viewfinder")
    static let person_badge_key: SymbolExtension = SymbolExtension(rawValue: "person.badge.key")
    static let person_badge_key_fill: SymbolExtension = SymbolExtension(rawValue: "person.badge.key.fill")
}
